      ...
      {!videoDetails && (
        <>
          ...
          <Box className="genre-pannel">
            ...
            <Box className="genre-btn">
              ...
              >
                <Button
                  ...
                  className={allGenre ? "genre" : undefined}
                >
                  All Genre
                </Button>
                <Button
                  onClick={() => setEducation(!education)}
                  className={education ? "genre" : undefined}
                >
                  Education
                </Button>
                <Button
                  onClick={() => setSports(!sports)}
                  className={sports ? "genre" : undefined}
                >
                  Sports
                </Button>
                <Button
                  onClick={() => setComedy(!comedy)}
                  className={comedy ? "genre" : undefined}
                >
                  Comedy
                </Button>
                <Button
                  onClick={() => setLifestyle(!lifestyle)}
                  className={lifestyle ? "genre" : undefined}
                >
                  Lifestyle
                </Button>
            ...
            <Box className="content-rating-btn" sx={{ margin: "2rem 1rem 0" }}>
              <Stack
                direction="row"
                alignItems="center"
                justifyContent="center"
              ...
              >
                <Button
                  ...
                  className={
                    contentRating.anyAge ? "content-rating" : undefined
                  }
                >
                  Any age group
                </Button>
                <Button
                  ...
                  className={
                    contentRating.sevenPlus ? "content-rating" : undefined
                  }
                >
                  7+
                </Button>
                <Button
                  ...
                  className={
                    contentRating.twelvePlus ? "content-rating" : undefined
                  }
                >
                  12+
                </Button>
                <Button
                  ...
                  className={
                    contentRating.sixteenPlus ? "content-rating" : undefined
                  }
                >
                  16+
                </Button>
                <Button
                  ...
                  className={
                    contentRating.eighteenPlus ? "content-rating" : undefined
                  }
                >
                  18+
                </Button>
